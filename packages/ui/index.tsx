...
export const Layout = ({ children, user, onSignIn, onSignOut, onProfile, onHome, onBulletin, onStudy }: LayoutProps) => (
  <Box sx={{ minHeight: '100vh', bgcolor: 'background.default' }}>
    <Navbar user={user} onSignIn={onSignIn} onSignOut={onSignOut} onProfile={onProfile} onHome={onHome} onBulletin={onBulletin} onStudy={onStudy} />
