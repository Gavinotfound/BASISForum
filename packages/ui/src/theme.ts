...
export const createBasisTheme = (mode: DisplayMode = 'dark') => {
  ...
  return createTheme({
    ...
    components: {
      ...
      MuiButton: {
        styleOverrides: {
          root: {
            ...
            '&:hover': { transform: 'none', boxShadow: 'none', backgroundColor: tokens.interactiveHover, color: '#FFFFFF' },
            '&:focus-visible': { outline: `1px solid ${tokens.interactive}`, outlineOffset: 2 },
            '&.MuiButton-contained.MuiButton-colorPrimary, &.MuiButton-contained.MuiButton-colorSecondary': {
              backgroundColor: tokens.text,
              color: tokens.background,
              '&:hover': { backgroundColor: tokens.interactiveHover, color: '#FFFFFF' },
            },
            ...
            '&.MuiButton-outlined': {
              ...
              '&:hover': { borderColor: tokens.interactiveHover, backgroundColor: tokens.interactiveHover, color: '#FFFFFF' },
            },
          },
        },
      },
      ...
      MuiMenu: { styleOverrides: { paper: { borderRadius: 0, backgroundColor: tokens.surface, backgroundImage: 'none', color: tokens.text, border: `1px solid ${tokens.divider}`, boxShadow: 'none', opacity: 1 }, list: { padding: 0 } } },
      MuiPopover: { styleOverrides: { paper: { borderRadius: 0, backgroundColor: tokens.surface, backgroundImage: 'none', color: tokens.text, border: `1px solid ${tokens.divider}`, boxShadow: 'none', opacity: 1 } } },
      MuiDialog: { styleOverrides: { paper: { borderRadius: 0, backgroundColor: tokens.surface, backgroundImage: 'none', color: tokens.text, border: `1px solid ${tokens.divider}`, boxShadow: 'none', opacity: 1 } } },
      MuiAutocomplete: { styleOverrides: { paper: { borderRadius: 0, backgroundColor: tokens.surface, backgroundImage: 'none', color: tokens.text, border: `1px solid ${tokens.divider}`, boxShadow: 'none', opacity: 1 } } },
      MuiTooltip: { styleOverrides: { tooltip: { borderRadius: 0, backgroundColor: tokens.surface, backgroundImage: 'none', color: tokens.text, border: `1px solid ${tokens.divider}`, boxShadow: 'none', opacity: 1 } } },
      MuiSnackbarContent: { styleOverrides: { root: { borderRadius: 0, backgroundColor: tokens.surface, backgroundImage: 'none', color: tokens.text, border: `1px solid ${tokens.divider}`, boxShadow: 'none', opacity: 1 } } },
      MuiMenuItem: { styleOverrides: { root: { minHeight: 36, fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace', fontSize: '0.68rem', letterSpacing: '.06em', '&:hover, &.Mui-focusVisible': { backgroundColor: tokens.interactiveHover, color: '#FFFFFF' }, '&.Mui-selected': { backgroundColor: tokens.text, color: tokens.background }, '&.Mui-selected:hover': { backgroundColor: tokens.interactiveHover, color: '#FFFFFF' } } } },
