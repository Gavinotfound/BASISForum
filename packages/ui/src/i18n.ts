...
const en: Messages = {
  ...
  'auth.welcome': 'Welcome Back!', 'auth.emailOrUsername': 'Email or username', 'auth.emailPlaceholder': 'e.g. test@example.com or test', 'auth.password': 'Password', 'auth.signingIn': 'Signing in…', 'auth.forgot': 'Forgot Password?', 'auth.join': 'Join the Study Hub!', 'auth.fullName': 'Full Name', 'auth.email': 'Email', 'auth.create': 'Create Account',
...
const zh: Messages = {
  ...
  'auth.welcome': '欢迎回来！', 'auth.emailOrUsername': '邮箱或用户名', 'auth.emailPlaceholder': '例如：test@example.com 或 test', 'auth.password': '密码', 'auth.signingIn': '正在登录…', 'auth.forgot': '忘记密码？', 'auth.join': '加入学习中心！', 'auth.fullName': '姓名', 'auth.email': '邮箱', 'auth.create': '创建账户',
...
const fr: Messages = {
  ...
  'auth.welcome': 'Bon retour !', 'auth.emailOrUsername': 'E-mail ou nom d’utilisateur', 'auth.emailPlaceholder': 'ex. test@example.com ou test', 'auth.password': 'Mot de passe', 'auth.signingIn': 'Connexion…', 'auth.forgot': 'Mot de passe oublié ?', 'auth.join': 'Rejoignez le centre d’étude !', 'auth.fullName': 'Nom complet', 'auth.email': 'E-mail', 'auth.create': 'Créer un compte',
...
const is: Messages = {
  ...
  'auth.welcome': 'Velkomin aftur!', 'auth.emailOrUsername': 'Netfang eða notandanafn', 'auth.emailPlaceholder': 't.d. test@example.com eða test', 'auth.password': 'Lykilorð', 'auth.signingIn': 'Skrái inn…', 'auth.forgot': 'Gleymt lykilorð?', 'auth.join': 'Komdu í námsmiðstöðina!', 'auth.fullName': 'Fullt nafn', 'auth.email': 'Netfang', 'auth.create': 'Búa til aðgang',
