...
export default function GlobalError({
  ...
  useEffect(() => {
    console.error('BasisForum Admin route error:', error);
  }, [error]);
  ...
  return (
    <main style={{ minHeight: '100vh', boxSizing: 'border-box', padding: 'clamp(24px, 6vw, 96px)', background: '#000000', color: '#FFFFFF', fontFamily: 'Inter, Helvetica, Arial, sans-serif' }}>
      <section aria-labelledby="admin-route-error-title" style={{ maxWidth: 760, borderTop: '2px solid #FFFFFF', borderBottom: '1px solid #404040', padding: '18px 0 28px' }}>
        <p style={{ margin: '0 0 14px', color: '#A3A3A3', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, monospace', fontSize: 11, fontWeight: 700, letterSpacing: '0.12em' }}>MODERATION DESK / RECOVERY</p>
        <h1 id="admin-route-error-title" style={{ margin: 0, fontSize: 'clamp(1.25rem, 3vw, 2rem)', letterSpacing: '-0.03em' }}>The moderation desk did not load.</h1>
        <p style={{ maxWidth: 520, margin: '14px 0 24px', color: '#A3A3A3', lineHeight: 1.55 }}>No moderation decision was applied. Retry the page before continuing with report review.</p>
