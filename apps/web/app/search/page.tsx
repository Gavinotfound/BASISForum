  ...
  return (
    <BasisProvider>
      <ClientLayout user={session?.user}>
        ...
        <Paper component="form" action="/search" sx={{ p: { xs: 2, md: 3 }, borderRadius: 3, mb: 3 }}>
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'minmax(0, 1fr) 190px 150px auto' }, gap: 1.5 }}>
            ...
            <TextField select name="sort" label="Sort" defaultValue={sort}>
